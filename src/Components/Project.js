...
function Project({ id, title, image, description, techstack, githubLink }) {
  const navigate = useNavigate();

  return (
    <article className="rounded-xl mt-10 overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900 flex flex-col h-full">
      ...
      <div className="dark:bg-dark-card p-4 flex-1 flex flex-col">
        <h1 className="dark:text-light-heading font-semibold text-lg pt-1">{title}</h1>
        <p className="text-content pt-4 font-light flex-1">{description}</p>
