    ...
    return (
      <main className="container mx-auto max-width pt-10 pb-20">
        <div className="text-center">
          ...
          <p className="text-content py-4">The project you're looking for doesn't exist.</p>
          <button 
    ...
    <main className="container mx-auto max-width pt-10 pb-20">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p className="text-content text-lg mb-6 leading-relaxed">
            {project.description}
          </p>
          
          <div className="mb-6">
            <h3 className="text-dark-heading dark:text-light-heading font-semibold text-xl mb-2">
              Tech Stack
            </h3>
